...
from user.views import public_user_profile, send_friend_request, accept_friend_request, unfriend, friend_requests, reject_friend_request, cancel_friend_request
